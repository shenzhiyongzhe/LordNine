const TipColorList = [
    ...
    ["#fff59e", [[0, 4, "#fff59e"], [8, 4, "#fff59e"], [14, 1, "#fff59e"], [14, 6, "#fff59e"]]],
    ["#fef49e", [[8, -2, "#fff59e"], [13, -2, "#fff59e"], [13, 2, "#fff59e"], [18, -2, "#f4eb98"]]],
    ["#fcf29d", [[0, 5, "#fcf29d"], [8, 2, "#fff59e"], [13, -1, "#f9f09b"], [19, -2, "#fef59e"]]],
    ["#ede7ab", [[0, 4, "#ede7ab"], [8, 1, "#efe9ad"], [14, 1, "#efe9ab"], [14, 4, "#efe9ad"]]]
...
const ArrowColorList = {
    up: [
        ...
        ["#ebeae9", [[1, -1, "#f6f6f6"], [2, -1, "#fcfcfc"], [3, 0, "#f3f3f2"], [4, 1, "#edeceb"]]],
        ["#b6b4b3", [[2, -1, "#f6f6f6"], [3, -1, "#fcfcfc"], [4, 0, "#f3f3f2"], [5, 1, "#edeceb"]]]
    ],
    down: [
        ...
        ["#f6f4ef", [[2, 1, "#fffffd"], [2, 2, "#f2f0ed"], [3, 1, "#fffffc"], [4, 1, "#e7e2dc"]]],
        ["#f1f0ed", [[2, 1, "#fefefc"], [2, 2, "#f0efeb"], [3, 1, "#fdfcfa"], [4, 0, "#f2f1ef"]]],
        ["#f3f1ed", [[1, 1, "#f4f2ef"], [2, 1, "#fffffc"], [2, 2, "#f0efeb"], [4, 0, "#f4f2ef"]]],
        ["#f1f0ed", [[1, 1, "#f3f1ef"], [2, 1, "#fffefc"], [3, 2, "#eae7e1"], [4, 0, "#f3f1ef"]]],
        ["#f1f0ed", [[1, 1, "#f2f1ef"], [2, 1, "#fefefc"], [2, 2, "#f0efeb"], [4, 0, "#f2f1ef"]]],
        ["#f3f3f2", [[1, 1, "#f6f6f4"], [2, 1, "#fdfdfc"], [2, 2, "#ecebe9"], [4, 0, "#e9e9e7"]]],
        ["#fcfaf8", [[2, 1, "#fffffc"], [3, 2, "#efeeeb"], [2, 2, "#f8f7f4"], [5, 1, "#918d87"]]],
        ["#fcfaf8", [[2, 2, "#f8f7f4"], [1, 1, "#fcfaf6"], [2, 1, "#fffefc"], [4, 0, "#f3f2ef"]]],
        ["#fcfaf6", [[1, 1, "#fcfaf6"], [2, 1, "#fffefc"], [2, 2, "#f8f7f4"], [4, 0, "#f3f2ed"]]],
        ["#fbf9f6", [[2, 1, "#fefefc"], [2, 2, "#f7f6f4"], [3, 2, "#eeedeb"], [4, 0, "#f2f1ed"]]],
        ["#fbf9f6", [[2, 2, "#f7f7f4"], [3, 1, "#fffffd"], [2, 1, "#fefefc"], [4, 0, "#f2f1ed"]]],
        ["#f2f0ef", [[3, 3, "#f8f7f4"], [3, 2, "#fffefc"], [4, 2, "#fffffd"], [5, 1, "#f3f2ef"]]],
        ["#f3f1ef", [[2, 2, "#fcfbf8"], [3, 3, "#f8f7f4"], [4, 3, "#efeeeb"], [6, 0, "#e7e5e1"]]],
        ["#f5f4f2", [[1, 1, "#fffffd"], [0, 1, "#e5e3df"], [0, 2, "#efeeeb"], [0, 3, "#edebe7"]]],
        ["#f8f6f4", [[1, 1, "#fffffd"], [0, 2, "#f1f0ed"], [1, 2, "#f0eee9"], [-1, 4, "#e5e3df"]]],
        ["#fcfaf6", [[1, 1, "#fcfaf6"], [2, 0, "#9c9891"], [2, 2, "#f8f7f4"], [3, 2, "#efeeeb"]]],
        ["#fcfaf8", [[2, 1, "#fffffc"], [2, 2, "#f8f7f4"], [3, 1, "#fffffd"], [4, 0, "#f3f2ef"]]],
        ["#f2f2f2", [[2, 2, "#fcfcfc"], [3, 2, "#f2f2f2"], [3, 1, "#f2f1f0"], [4, 0, "#e0dfdf"]]],
        ["#fafafa", [[2, 0, "#f3f3f2"], [1, 0, "#f1f1f0"], [2, 1, "#f7f7f6"], [3, -1, "#e1e0df"]]]
    ...
    right: [
        ...
        ["#e0deda", [[1, 1, "#e4e3e1"], [2, 2, "#f0f0ef"], [2, 3, "#fdfcfc"], [1, 4, "#eceae9"]]],
        ["#a4a2a0", [[1, 2, "#f0f0f0"], [1, 3, "#fcfcfc"], [1, 4, "#e7e7e5"], [0, 5, "#e5e5e3"]]],
        ["#f3f1ed", [[1, 0, "#f3f2ef"], [1, 1, "#ffffff"], [1, 2, "#fcfbf6"], [0, 3, "#f9f7f2"]]],
        ["#f5f4f2", [[1, 0, "#eae8e3"], [1, 1, "#fffffd"], [0, 2, "#efeeeb"], [0, 3, "#edebe7"]]],
        ["#f7f5f2", [[1, 1, "#ffffff"], [1, 2, "#f0eeeb"], [0, 2, "#f0efeb"], [-1, 4, "#e1e0dc"]]],
        ["#edece7", [[1, 1, "#f7f5f2"], [2, 1, "#ebe8e3"], [2, 2, "#fffffd"], [0, 4, "#e9e6e1"]]],
        ["#ebeae5", [[2, 2, "#ebeae5"], [1, 2, "#ffffff"], [1, 3, "#f7f6f2"], [0, 3, "#e1dfd8"]]],
        ["#ebe9e5", [[0, 1, "#eeece7"], [2, 2, "#ebeae5"], [1, 2, "#ffffff"], [0, 4, "#f6f4ef"]]],
        ["#f4f2ef", [[1, 1, "#e8e8e3"], [-1, 1, "#c1beba"], [0, 2, "#f5f4f0"], [-1, 3, "#f3f2ef"]]],
        ["#e8e8e5", [[1, 0, "#f1f0ef"], [1, 1, "#fffffd"], [1, 3, "#bfbeba"], [0, 3, "#f0f0ed"]]],
        ["#f2f0eb", [[2, 2, "#fffffd"], [2, 3, "#fffffc"], [1, 4, "#fffefc"], [-1, 6, "#eeebe5"]]],
        ["#fffefa", [[1, 2, "#e8e6e1"], [2, 3, "#ffffff"], [2, 4, "#fffefc"], [1, 5, "#fdfcf8"]]],
        ["#fafaf6", [[1, 2, "#fffffd"], [2, 2, "#fcfbf8"], [1, 3, "#fcfcfa"], [0, 4, "#fafaf6"]]],
        ["#fefdfa", [[0, 0, "#fefdfa"], [1, 1, "#fbfbf8"], [0, 3, "#e7e6e3"], [-2, 4, "#f0f0ef"]]],
        ["#fefcf8", [[1, 1, "#fffffc"], [2, 2, "#fdfcfa"], [1, 2, "#ffffff"], [0, 4, "#fefcf8"]]]
    ],
    left: [
        ...
        ["#f0efef", [[-1, 1, "#f7f7f6"], [-2, 2, "#fbfbfa"], [-2, 3, "#fefefd"], [-1, 4, "#f0f0ef"]]],
        ["#f7f7f6", [[-1, 1, "#fbfbfa"], [-1, 2, "#fefefd"], [-2, 2, "#e8e8e7"], [0, 3, "#f0f0ef"]]],
        ["#eeeeed", [[-1, 1, "#f5f4f4"], [-2, 1, "#e0dfdf"], [-2, 2, "#fdfdfd"], [-1, 3, "#f9f9f8"]]],
        ["#eeeeed", [[-1, 1, "#f5f4f4"], [-2, 2, "#fdfdfd"], [-1, 2, "#f1f1f0"], [-1, 3, "#f9f9f8"]]],
        ["#f5f4f4", [[-1, 1, "#fbfbfa"], [-2, 2, "#fcfcfc"], [-1, 2, "#fdfdfd"], [-1, 3, "#fefefd"]]],
        ["#fcfbf6", [[-1, 1, "#fffffc"], [-1, 2, "#fbfaf4"], [0, 2, "#eeece7"], [0, 3, "#f1f0eb"]]],
        ["#e7e7e7", [[-1, 1, "#dededc"], [0, 1, "#fcfcfc"], [0, 2, "#f6f6f4"], [1, 3, "#e9e9e9"]]]
    ],
};
...
const NextColorList = [
    ...
    ["#ffd074", [[6, 0, "#f9cc71"], [7, -6, "#ffd074"], [13, 0, "#ffd074"], [9, 6, "#e4bc67"]]]
];
...
module.exports = {
    TipColorList, ArrowColorList, BlankColorList, NextColorList,
